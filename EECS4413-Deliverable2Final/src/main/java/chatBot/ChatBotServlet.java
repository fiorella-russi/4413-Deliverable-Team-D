...
public class ChatBotServlet extends HttpServlet {
    ...
    public void init() {
        ...
        chatBotAnswers.put("hi", 
        		"Hello, Welcome to e-Carmerce! Is there anything I could help you with?");
        ...
        chatBotAnswers.put("help", 
        		"Here is a list of predefined questions, let me know how I can help!"
        			...
        			+"<br>\"Where can I find car for sale?\""
        			+"<br>\"Do you have any sales?\""
        			+"<br>\"Can I calculate my loan payments?\""
        			+"<br>\"What is in my cart?\""
        			+"<br>\"How can I create an account?\"");
